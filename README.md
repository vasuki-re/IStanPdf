...
IStanPdf is a foss offline Android application designed to replace freemium websites or apps for pdf and docx operations. It processes your files entirely on-device, ensuring complete privacy with zero file size limits, subscriptions, or network requirements.

## Features

### PDF Tools
- **Merge PDF** - Combine multiple PDF files into one.
- **Modify PDF** - Remove or reorder pages within a PDF.
- **Compress PDF** - Reduce file size by resolution or custom target size.

### Conversions
- **Image to PDF** - Convert images into a single PDF document.
- **PDF to Image** - Extract PDF pages into a ZIP file of images.
- **DOCX to PDF** - Convert Word documents into PDF files.
- **MD to PDF** - Convert Markdown or plain text files into PDFs.

### DOCX Tools
- **Remove Pages** - Delete specific pages from DOCX files.
- **Reorder Pages** - Rearrange pages within DOCX files.
...
IStanPdf is built for the community. Bug reports, feature requests, and pull requests are welcome. 
If you find the application useful, consider supporting its development.

<div align="center">
  <a href="https://github.com/vasuki-re/IStanPdf/issues">Bug Reports</a>
  <span>&nbsp;&middot;&nbsp;</span>
  <a href="https://github.com/vasuki-re/IStanPdf/pulls">Contributions</a>
  <span>&nbsp;&middot;&nbsp;</span>
  <a href="https://ko-fi.com/ramakanthgacharya">Support via Ko-fi</a>
  <span>&nbsp;&middot;&nbsp;</span>
  <span>UPI: <code>ramakanthacharya@axl</code></span>
</div>

## Acknowledgements

* **iLovePDF & Smallpdf** - Operations and UI Design.
* [LibreOffice](https://github.com/LibreOffice/core) - Core DOCX engine.